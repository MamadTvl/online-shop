    ...
    return (
        <Card className={classes.commentCard}>
            ...
            <Typography
                className={
                    isPreview
                        ? classes.commentPreviewDescription
